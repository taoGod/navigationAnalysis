...
- (void)textChanged:(UITextField *)textField {    
    ...
    switch (_formatterType) {
        ...
        {
            regexString = [NSString stringWithFormat:@"^\\d{0,%lu}$", _limitedLength];
            regexString = @"^\\d*$";
            break;
        }
        ...
        {
            regexString = [NSString stringWithFormat:@"^[a-zA-Z]{0,%lu}$", _limitedLength];
//            regexString = @"^[a-zA-Z]*$";
            break;
        }
        case WKFormatterTypeNumberAndAlphabet:
        {
            regexString = [NSString stringWithFormat:@"^[a-zA-Z0-9]{0,%lu}$", _limitedLength];
